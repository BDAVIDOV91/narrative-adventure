...
| 9   | Honour `prefers-reduced-motion` (added 09-24)     | Nothing in `src/` reads it yet. Build it **into** #3's overlay/zoom and #6's engines, not as a retrofit: the book-zoom transition and any auto-rotation need an instant or reduced path. Rule: `.claude/rules/standards-frontend.md`. What "reduced" means per animation is a design call — ask the owner.                                                                                                                                                                                                                                                          |
